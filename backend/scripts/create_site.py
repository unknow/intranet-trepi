...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-trepi.intranet:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-trepi.intranet:initial")
        transaction.commit()
    app._p_jar.sync()
